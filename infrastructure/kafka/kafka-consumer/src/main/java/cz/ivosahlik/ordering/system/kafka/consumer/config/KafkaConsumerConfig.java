package cz.ivosahlik.ordering.system.kafka.consumer.config;

import cz.ivosahlik.ordering.system.kafka.config.data.KafkaConfigData;
import cz.ivosahlik.ordering.system.kafka.config.data.KafkaConsumerConfigData;
